...
public class Main:SEScene
{
    ...
    public void initialize(SEResourceCache rsc) {
        base.initialize(rsc);
        bg = add_sprite_for_color (Color.instance("#ded4e0") , get_scene_width(), get_scene_height() ); 
        bg.move(0,0);
        fg = add_sprite_for_color (Color.instance("#ffaabc") , get_scene_width()*0.1, get_scene_height()*0.1);
        fg.move(100,100);
